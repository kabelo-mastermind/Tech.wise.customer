...
const OnboardingScreen: React.FC<OnboardingScreenProps> = ({ navigation }) => {
        ...
        Animated.parallel([
            ...
            Animated.timing(textOpacity, {
                ...
                Animated.timing(loadingOpacity, {
                    ...
                    setTimeout(() => {
                        navigation.replace("NthomeFoodLanding") // Replace with your target screen
                    }, 5000)
                })
            })
        })
    ...
    return (
        <View style={styles.container}>
            ...
            {/* Background Image */}
            <ImageBackground
                source={require('../../assets/nthomeFood_images/food_welcome.jpg')}
                        ...
                        <View style={styles.content}>
                            ...
                            >
                                <View style={styles.logoWrapper}>
                                    ...
                                    <Image
                                        ...
                                        resizeMode="contain"
                                    />
                                    <Text style={styles.logoText}>NthomeFood</Text>
                            ...
                            <Animated.View style={[styles.textContainer, { opacity: textOpacity }]}>
                                ...
                                <Text style={styles.subtitleText}>
                                    Experience fresh, delicious meals crafted with care and delivered to you
                                </Text>
                            </Animated.View>
